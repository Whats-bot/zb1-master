...
${tradutor.texto6[0]} | ИЗМЕНЕНИЯ
${tradutor.texto6[1]} ${usedPrefix + command} detect
${tradutor.texto6[2]}

--------------------------------

${tradutor.texto7[0]} | ИЗМЕНЕНИЯ 2
...
${tradutor.texto20[0]} | ТОЛЬКО АДМИНЫ
...
break;
  ...
  conn.sendMessage(m.chat, {text: `_*${tradutor.texto28[0]}*_\n\n*${tradutor.texto28[1]}* _${type}_ *fue* ${isEnable ? '_activada_' : '__'} *${tradutor.texto28[2]}* ${isAll ? '_bot._' : isUser ? '' : '_chat._'}`}, {quoted: m});
